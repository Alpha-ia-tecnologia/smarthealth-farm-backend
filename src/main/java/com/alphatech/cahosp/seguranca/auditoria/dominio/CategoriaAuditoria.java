...
public enum CategoriaAuditoria {
    ...
    EXECUTAR_RECOMENDACAO("Execução de recomendação", "Executou recomendação",
            "Execução de contrato (art. 7º, V)", false),
    CRIAR_RECOMENDACAO("Criação de recomendação", "Criou transferência manual",
            "Execução de contrato (art. 7º, V)", false),
    EDITAR_RECOMENDACAO("Edição de recomendação", "Editou recomendação",
            "Execução de contrato (art. 7º, V)", false),
    RECUSAR_RECOMENDACAO("Recusa de recomendação", "Recusou recomendação",
            "Execução de contrato (art. 7º, V)", false),
